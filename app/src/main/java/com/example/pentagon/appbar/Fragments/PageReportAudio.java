 ...
 * {@link PageReportAudio.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PageReportAudio#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PageReportAudio extends Fragment {
...
View view;
    ...
    public static PageReportAudio newInstance(String param1, String param2) {
        PageReportAudio fragment = new PageReportAudio();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=  inflater.inflate(R.layout.viewcontentaudio, container, false);
        noimage=view.findViewById(R.id.textView4) ;
        recyaudios=view.findViewById(R.id.recyclerView2);
 ...
 ddaudio=new ArrayList<>();
        ...
        recyaudios.addOnItemTouchListener(new RecyclerItemClickListener(context, recyaudios, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view,  int position) {
                AudioRecordDialog.dataPreview=ddaudio.get(position);
                new AudioRecordDialog(context,true);
            }
        ...
        audios.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
